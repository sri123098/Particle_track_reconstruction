...
model_Unet.load_weights("../base_Unet/Unet_epoch_20_batch_4.hdf5")

print("Train autoencoder")
mygen_image = My_Generator("Data/newdataset", batch_size=batch_size, data_shape=data_shape, output='image')
model_Unet.fit_generator(mygen_image.Generator(), epochs=epochs, steps_per_epoch=5, verbose=1, callbacks=unet_callbacks)
...
#mygen_label = My_Generator("Data/newdataset", batch_size=batch_size, data_shape=data_shape, output='label')
...
#model_Classify.fit_generator(mygen_label.Generator(), epochs=epochs, steps_per_epoch=20, verbose=1, callbacks=classify_callbacks)
