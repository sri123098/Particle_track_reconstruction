...
model_Classify.load_weights("Classify_epoch_9_batch_5.hdf5")
model_Classify.compile(optimizer=Adam(lr=1e-4), loss = 'binary_crossentropy', metrics = ['accuracy'])
model_Classify.fit_generator(mygen_label.Generator(), epochs=epochs, steps_per_epoch=200, verbose=1, callbacks=classify_callbacks)
